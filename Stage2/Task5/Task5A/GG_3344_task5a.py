...
events_priority=["fire","destroyed_buildings","human_aid_rehabilitatiion","military_vehicles","combat"]
path_event_node=[]
...
def get_path(start,end):
    V, E = 20, 26
    edges = [[17,1,2],[1,2,2],[2,3,2],[3,4,2],[4,18,2],[18,7,1],[7,19,5],[19,16,2],[1,5,1],[5,8,2],[2,9,3],[3,6,1],[6,10,2],[4,11,3],[8,20,4],[20,14,2],[8,9,2],[9,10,2],[10,11,2],[11,16,3],[10,13,2],[13,15,1],[9,12,2],[12,14,1],[14,15,2],[15,16,2]]
...
ip = "192.168.188.144"     #Enter IP address of laptop after connecting it to WIFI hotspot
    ...
    with conn:
        ...
        try:
            ...
            for event in path_event_node:
                while True:
                    try:
                        location = [tuple(x) for x in pd.read_csv('live_data.csv', header=None).values.tolist()][1]
                    except:
                        continue
                    print(location)
                    if location==event_aruco_location[event]:
                        # sleep(2);
