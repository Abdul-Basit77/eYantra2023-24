...
# Team ID:			[ 3344]
# Author List:		[ Abhay Agrawal,Mohammad Kaif ]
# Filename:			Task_2D.py
...
def write_csv(loc, csv_name):
    ...
    with open(csv_name,"w") as csv_file:
        ...
        csv_file_writer.writerows((["lat","lon"],loc))
...
def tracker(ar_id, lat_lon):
    ...
    #coordinate[0],coordinate[1]=float(coordinate[0]),float(coordinate[1])
    csv_name="live_data.csv"
    write_csv(coordinate,csv_name)
    #print(coordinate)
